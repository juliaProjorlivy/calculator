...
SRCS = src/ctor_dtor.cpp src/main.cpp src/dump.cpp src/reader.cpp src/derivative.cpp src/variables.cpp src/calculate_function.cpp src/simplifier.cpp src/parse.cpp src/taylor_func.cpp src/io.cpp
